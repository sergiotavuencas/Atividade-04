...
public class AuthorController {
    ...
    @GetMapping("/edit")
    public ModelAndView editAuthor(@RequestParam Integer author_id) {
        ModelAndView mv = new ModelAndView("authorEdit");
    ...
    @GetMapping("/remove")
    public String removeAuthor(@RequestParam Integer author_id) {
        Author author = authorService.getAuthorById(author_id);
