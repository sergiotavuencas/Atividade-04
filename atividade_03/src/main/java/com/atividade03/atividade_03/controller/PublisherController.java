...
public class PublisherController {
    ...
    @GetMapping("/edit")
    public ModelAndView editPublisher(@RequestParam Integer publisher_id) {
        ModelAndView mv = new ModelAndView("publisherEdit");
    ...
    @GetMapping("/remove")
    public String removePublisher(@RequestParam Integer publisher_id) {
        Publisher publisher = publisherService.getPublisherById(publisher_id);
